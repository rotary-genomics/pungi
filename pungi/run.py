...
def run_snakemake_workflow(config_path, snake_file_path, output_dir_path, conda_env_dir_path, jobs=None,
    ...
    :param conda_env_dir_path: Path where conda environments generated by snakemake should be stored.
